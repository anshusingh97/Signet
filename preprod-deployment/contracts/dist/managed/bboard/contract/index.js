...
class _MerkleTreePath_0 {
  alignment() {
    return _descriptor_4.alignment().concat(_descriptor_7.alignment());
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_4.toValue(value_0.leaf).concat(_descriptor_7.toValue(value_0.path));
  }
}
...
class _LeafPreimage_0 {
  ...
  toValue(value_0) {
    return _descriptor_10.toValue(value_0.domain_sep).concat(_descriptor_4.toValue(value_0.data));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.credentialTier) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named credentialTier');
    }
    ...
    this.circuits = {
      openGate: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`openGate: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        if (!(typeof(root_0) === 'object' && typeof(root_0.field) === 'bigint' && root_0.field >= 0 && root_0.field <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('openGate',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_9.toValue(name_0).concat(_descriptor_1.toValue(minTier_0).concat(_descriptor_3.toValue(root_0))),
            alignment: _descriptor_9.alignment().concat(_descriptor_1.alignment().concat(_descriptor_3.alignment()))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
        };
        const result_0 = this._openGate_0(context,
                                          partialProofData,
                                          name_0,
                                          minTier_0,
                                          root_0);
      ...
      presentCredential: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`presentCredential: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._presentCredential_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      closeGate: (...args_1) => {
  ...
  _credentialTier_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.credentialTier(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 255n)) {
      __compactRuntime.typeError('credentialTier',
                                 'return value',
  ...
  _openGate_0(context, partialProofData, name_0, minTier_0, root_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(1n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(minTier_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _presentCredential_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            'gate is closed');
    const secret_0 = this._credentialSecret_0(context, partialProofData);
    const tier_0 = this._credentialTier_0(context, partialProofData);
    const path_0 = this._credentialPath_0(context, partialProofData);
    __compactRuntime.assert(tier_0
                            >=
    ...
    __compactRuntime.assert(this._equal_1(computedRoot_0,
                                          _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value)),
                            'credential was not issued by the trusted issuer');
    const nullifier_0 = this._persistentHash_3(secret_0);
    __compactRuntime.assert(!_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
